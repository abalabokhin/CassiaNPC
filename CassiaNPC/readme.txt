...
As an optional sub-component, you are given the option to modify the existing healing spells in Icewind Dale so that they can affect tieflings. In certain versions of the game the Tiefling race is immune to healing spells and thus cannot be healed by them. This component deletes the effect in question from the spells which grant this immunity. This component does not touch any of the 'harming' spells. My recommendation is to quickly check if you can heal Cassia without installing this component (she starts with 1 cure light wounds memorized for this purpose.). If the spell fails to affect her, install this component.
