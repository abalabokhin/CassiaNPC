...
//SKINEATER QUEST
//Skineater Area entered:
CHAIN IF WEIGHT #-5 ~Global("AWCassSkineaterAreaReact","GLOBAL",1)~ THEN AWCassJ CASS.REACTIONTOSKINEATER.00
@1039
END
++ @1040 + CASS.REACTIONTOSKINEATER.01
++ @1041 + CASS.REACTIONTOSKINEATER.02
++ @1042 + CASS.REACTIONTOSKINEATER.03
++ @1043 + CASS.REACTIONTOSKINEATER.01

CHAIN AWCassJ CASS.REACTIONTOSKINEATER.01
@1044
EXTERN AWCassJ CASS.REACTIONTOSKINEATER.04

CHAIN AWCassJ CASS.REACTIONTOSKINEATER.02
@1045
EXTERN AWCassJ CASS.REACTIONTOSKINEATER.04

CHAIN AWCassJ CASS.REACTIONTOSKINEATER.03
@1046 
EXTERN AWCassJ CASS.REACTIONTOSKINEATER.04

CHAIN AWCassJ CASS.REACTIONTOSKINEATER.04
@1047 DO ~IncrementGlobal("AWCassSkineaterAreaReact","GLOBAL",1)~ EXIT

//Ellianh Slain
CHAIN IF WEIGHT #-5 ~Global("AWCassELLIANHDEAD","GLOBAL",1)~ THEN AWCassJ CASS.REACTIONTOELLIANHDEAD.00
@1048
END
++ @1049 + CASS.REACTIONTOELLIANHDEAD.01
++ @1050 + CASS.REACTIONTOELLIANHDEAD.02
++ @1051 + CASS.REACTIONTOELLIANHDEAD.03

CHAIN AWCassJ CASS.REACTIONTOELLIANHDEAD.01
@1052
EXTERN AWCassJ CASS.REACTIONTOELLIANHDEAD.04

CHAIN AWCassJ CASS.REACTIONTOELLIANHDEAD.02
@1053
EXTERN AWCassJ CASS.REACTIONTOELLIANHDEAD.04

CHAIN AWCassJ CASS.REACTIONTOELLIANHDEAD.03
@1054
EXTERN AWCassJ CASS.REACTIONTOELLIANHDEAD.04

CHAIN AWCassJ CASS.REACTIONTOELLIANHDEAD.04
@1055 DO ~IncrementGlobal("AWCassELLIANHDEAD","GLOBAL",1)~ EXIT

//Snowytoes Yondalla Shield
CHAIN IF WEIGHT #-5 ~Global("AWCassYONDALLASHIELD","GLOBAL",1)~ THEN AWCassJ CASS.REACTIONTOYONDALLA.00
@1056
DO ~IncrementGlobal("AWCassYONDALLASHIELD","GLOBAL",1)~
END
++ @1057 + CASS.REACTIONTOYONDALLA.01
++ @1058 + CASS.REACTIONTOYONDALLA.02
+ ~Race(PLAYER1,HALFLING)~ + @1059 + CASS.REACTIONTOYONDALLA.03
++ @1060 + CASS.REACTIONTOYONDALLA.04

CHAIN AWCassJ CASS.REACTIONTOYONDALLA.01
@1061
EXTERN AWCassJ CASS.REACTIONTOYONDALLA.05

CHAIN AWCassJ CASS.REACTIONTOYONDALLA.02
@1062
= @1063
EXTERN AWCassJ CASS.REACTIONTOYONDALLA.05

CHAIN AWCassJ CASS.REACTIONTOYONDALLA.03
@1064
EXTERN AWCassJ CASS.REACTIONTOYONDALLA.05

CHAIN AWCassJ CASS.REACTIONTOYONDALLA.04
@1065 EXIT

CHAIN AWCassJ CASS.REACTIONTOYONDALLA.05
@1066 EXIT

//The Rediscovery of Kuldahar, Jeweller
CHAIN IF WEIGHT #-5 ~Global("AWCassKULDAHARJEWELLER","GLOBAL",1)~ THEN AWCassJ CASS.REACTIONTOJEWELLER.00
@1067
= @1068
DO ~IncrementGlobal("AWCassKULDAHARJEWELLER","GLOBAL",1)~
END
++ @1069 + CASS.REACTIONTOJEWELLER.01
++ @1070 + CASS.REACTIONTOJEWELLER.02
+ ~Global("AWCass-RomanceMatch","GLOBAL",1)~ + @1071 + CASS.REACTIONTOJEWELLER.07 //RomanceMatch
+ ~OR(2)
!Global("AWCass-RomanceMatch","GLOBAL",1)
PartyGoldLT(7)~ + @1071 + CASS.REACTIONTOJEWELLER.06 //No RomanceMatch or too poor to buy a silver ring.

CHAIN AWCassJ CASS.REACTIONTOJEWELLER.01
@1072
EXTERN AWCassJ CASS.REACTIONTOJEWELLER.03

CHAIN AWCassJ CASS.REACTIONTOJEWELLER.02
@1073
EXTERN AWCassJ CASS.REACTIONTOJEWELLER.03

CHAIN AWCassJ CASS.REACTIONTOJEWELLER.03
@1074
END
++ @1075 + CASS.REACTIONTOJEWELLER.04 
++ @1076 + CASS.REACTIONTOJEWELLER.04 
++ @1077 + CASS.REACTIONTOJEWELLER.05
+ ~Global("AWCass-RomanceMatch","GLOBAL",1) PartyGoldGT(6)~ + @1071 + CASS.REACTIONTOJEWELLER.07 //RomanceMatch
+ ~OR(2)
!Global("AWCass-RomanceMatch","GLOBAL",1)
PartyGoldLT(7)~ + @1071 + CASS.REACTIONTOJEWELLER.06 //No RomanceMatch or too poor to buy a silver ring.

CHAIN AWCassJ CASS.REACTIONTOJEWELLER.04
@1078 EXIT

CHAIN AWCassJ CASS.REACTIONTOJEWELLER.05
@1079 EXIT

CHAIN AWCassJ CASS.REACTIONTOJEWELLER.06
@1080 EXIT

CHAIN AWCassJ CASS.REACTIONTOJEWELLER.07
@1081
END
++ @1082 + CASS.REACTIONTOJEWELLER.08
++ @1083 + CASS.REACTIONTOJEWELLER.08
++ @1084 EXIT
...
CHAIN AWCassJ CASS.REACTIONTOJEWELLER.09
@1089
= @1090 EXIT

CHAIN AWCassJ CASS.REACTIONTOJEWELLER.10
@1091
= @1092 EXIT

//The Rediscovery of Kuldahar, Cat resurrected
CHAIN IF WEIGHT #-5 ~Global("AWCassKULDAHARCAT","GLOBAL",1)~ THEN AWCassJ CASS.REACTIONTOCAT.00 //~Global("L#KUIDontWannaBeBuried","GLOBAL",2) !GlobalTimerExpired("L#KUCATCONTINUES","GLOBAL")~
@1093
DO ~IncrementGlobal("AWCassKULDAHARCAT","GLOBAL",1)~ EXIT

//Our Lady Dreamless, Pond Entered first time (L#UF12)
CHAIN IF WEIGHT #-5 ~Global("AWCassLADYPOND","GLOBAL",1)~ THEN AWCassJ CASS.REACTIONTOPOND.00
@1094
DO ~IncrementGlobal("AWCassLADYPOND","GLOBAL",1)~
END
++ @1095 + CASS.REACTIONTOPOND.01
++ @1096 + CASS.REACTIONTOPOND.01
++ @1097 + CASS.REACTIONTOPOND.01

CHAIN AWCassJ CASS.REACTIONTOPOND.01
@1098 EXIT

//Below Below Inn, Chest recovered
CHAIN IF WEIGHT #-5 ~Global("AWCassBELOWCHEST","GLOBAL",1)~ THEN AWCassJ CASS.REACTIONTOCHEST.00
@1099 DO ~IncrementGlobal("AWCassBELOWCHEST","GLOBAL",1)~EXIT
